...
// Использование:
checkReexports("./src/behaviors/index.ts");
checkReexports("./src/boolean/index.ts");
checkReexports("./src/controls/index.ts");
checkReexports("./src/navigation/index.ts");
checkReexports("./src/strings/index.ts");
checkReexports("./src/structures/index.ts");
checkReexports("./src/system/index.ts");
