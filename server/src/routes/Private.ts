    ...
    return (user) => {
		const rd = Router(
			...
			Of([
                ...
                template: () => CRUDRouter(req, mongoTransport, '/private/articles', 'documents'),
                },
                {
                pattern: "^.+:/private/categories.*$",
                template: () => CRUDRouter(req, mongoTransport, '/private/categories', 'categories'),
                },
                {
                pattern: "^.+:/private/settings.*$",
                template: () => CRUDRouter(req, mongoTransport, '/private/settings', 'settings'),
                },
			]),
